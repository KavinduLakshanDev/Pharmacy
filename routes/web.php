...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::prefix('inventory')->name('inventory.')->middleware('permission:manage-inventory')->group(function () {
            ...
            Route::get('customer-payments/create', [\App\Http\Controllers\CustomerPaymentController::class, 'create'])->middleware('permission:view-inventory-transactions')->name('customer-payments.create');
