            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold text-orange-600 leading-tight">{window.appSettings?.formatDateTime(salesOrder.order_date, false) || new Date(salesOrder.order_date).toLocaleDateString()}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-lg font-bold text-orange-600 leading-tight">{window.appSettings?.formatDateTime(salesOrder.delivery_date, false) || new Date(salesOrder.delivery_date).toLocaleDateString()}</h3>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1">{window.appSettings?.formatDateTime(salesOrder.created_at, false) || new Date(salesOrder.created_at).toLocaleDateString()}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">{t('Updated At')}</label>
                  <p className="text-sm mt-1">{window.appSettings?.formatDateTime(salesOrder.updated_at, false) || new Date(salesOrder.updated_at).toLocaleDateString()}</p>
                </div>
              </div>
            </div>
          </CardContent>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {salesOrder.billingContact ? (
                      <Link 
                        href={route('contacts.show', salesOrder.billingContact.id)} 
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {salesOrder.shippingContact ? (
                      <Link 
                        href={route('contacts.show', salesOrder.shippingContact.id)} 
                        className="block text-sm text-blue-600 hover:text-blue-800 hover:underline mt-1 transition-colors"
                      >
