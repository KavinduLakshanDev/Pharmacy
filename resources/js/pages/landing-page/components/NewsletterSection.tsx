      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white rounded-xl p-8 md:p-12 border border-gray-200">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {sectionData?.title || 'Stay Updated with Sales SaaS'}
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed font-medium" id="newsletter-description">
            {sectionData?.subtitle || 'Get the latest sales strategies, product updates, and growth insights.'}
          </p>
          ...
          <p className="text-gray-500 text-sm mt-4">
            {sectionData?.privacy_text || 'We value your privacy — no spam, unsubscribe anytime.'}
          </p>
