        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight" role="banner" aria-label="Main heading">
              {sectionData.title || 'All-in-One Sales SaaS to Power Your Business Growth'}
            </h1>
            
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl font-medium">
              {sectionData.subtitle || 'Manage leads, opportunities, quotes, orders, invoices, projects, and reports — all from one platform.'}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              <Link
                ...
                aria-label="Start free trial - Register for Sales Saas"
              >
              ...
              <Link
                ...
                aria-label="Login to existing Sales Saas account"
              >
                <Play size={18} />
