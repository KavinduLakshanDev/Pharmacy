...
export default function CreateSupplier() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await router.post(route('suppliers.store'), formData, {
      onSuccess: () => {
  ...
  return (
    <PageTemplate
      ...
      description={t('Create a new supplier record')}
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="tel_no">{t('Telephone')}</Label>
                <Input
                  id="tel_no"
              ...
              <div className="space-y-2">
                <Label htmlFor="vat_registered">{t('VAT Registered')} <span className="text-red-500">*</span></Label>
                <Select
            ...
            <div className="flex justify-end gap-4">
              ...
              <Button type="submit" disabled={isSubmitting}>
                ...
                {isSubmitting ? t('Creating...') : t('Create Supplier')}
              </Button>
            </div>
          </form>
        </CardContent>
