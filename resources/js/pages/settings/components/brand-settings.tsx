...
export const getBrandSettings = (userSettings?: Record<string, string>): BrandSettings => {
    ...
    //   return savedSettings ? JSON.parse(savedSettings) : DEFAULT_BRAND_SETTINGS;
      ...
      const layoutPosition = getCookie('layoutDirection') as LayoutPosition | null;
      ...
      return {
        logoDark: getFullUrl(parsedBrand?.logoDark, DEFAULT_BRAND_SETTINGS.logoDark),
        logoLight: getFullUrl(parsedBrand?.logoLight, DEFAULT_BRAND_SETTINGS.logoLight),
        favicon: getFullUrl(parsedBrand?.favicon, DEFAULT_BRAND_SETTINGS.favicon),
        ...
        layoutDirection: layoutPosition === 'left' || layoutPosition === 'right' ? layoutPosition : DEFAULT_BRAND_SETTINGS.layoutDirection,
  ...
  if (userSettings) {
    const getFullUrl = (path: string, defaultPath: string) => {
      ...
      const userLayoutDirection = userSettings.layoutDirection as LayoutPosition | undefined;
      return {
      ...
      layoutDirection: userLayoutDirection === 'left' || userLayoutDirection === 'right' ? userLayoutDirection : DEFAULT_BRAND_SETTINGS.layoutDirection,
...
export default function BrandSettings({ userSettings }: BrandSettingsProps) {
  ...
  const getDisplayUrl = (path: string): string => {
    ...
    // Already a full URL
    if (path.startsWith('http')) return path;
    // Any absolute path — just prepend origin, no basePath injection
  ...
  const handleMediaSelect = (name: string, url: string) => {
    console.log("Media Select function : "+url+" - Name : "+name);
  ...
  const saveSettings = () => {
    ...
    const payload = { settings: settings as Record<string, any> };

    router.post(route('settings.brand.update'), payload, {
      preserveScroll: true,
      onSuccess: (page) => {
        setIsLoading(false);
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <MediaPicker
                      ...
                      onChange={(url) => handleMediaSelect('logoDark', String(url))}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <MediaPicker
                      ...
                      onChange={(url) => handleMediaSelect('logoLight', String(url))}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <MediaPicker
                      ...
                      onChange={(url) => handleMediaSelect('favicon', String(url))}
              ...
              <div className="flex flex-col space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-7 gap-2">
                    {Object.entries({ blue: '#3b82f6', teal: '#0d9488', green: '#10b981', purple: '#8b5cf6', orange: '#f97316', red: '#ef4444' }).map(([color, hex]) => (
                      <Button
                        key={color}
                        type="button"
                    ...
                    <div className="space-y-2 mt-4">
                      ...
                      <div className="flex gap-2">
                        <div className="relative">
                          ...
                          onChange={(e) => handleCustomColorChange(String(e.target.value))}
