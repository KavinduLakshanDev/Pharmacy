...
import { Plus, Eye, Edit, Trash2, MoreHorizontal, Building2, User, Users } from 'lucide-react';
...
export default function Leads() {
  ...
  const { auth, leads, leadStatuses = [], leadSources = [], accounts = [], campaigns = [], accountIndustries = [], accountTypes = [], users = [], filters: pageFilters = {}, kanbanData: initialKanbanData } = usePage().props as any;
