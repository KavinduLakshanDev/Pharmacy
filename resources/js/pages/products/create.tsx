...
export default function ProductCreate() {
  ...
  const { categories, initialType, units = [], genericNames = [], drugForms = [] } = usePage().props as any;
  const productType = 'Finished product';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submitData = {
      ...
      expire_date: formData.expire_date ? parseInt(formData.expire_date) : null,
      ...
      generic_name_id: formData.generic_name_id || null,
      drug_form_id: formData.drug_form_id || null,
  ...
  const pageTitle = t('Create Product');
  const pageDescription = t('Create a new product with pricing options');

  return (
    <PageTemplate
      title={pageTitle}
      description={pageDescription}
      url={route('products.create', { type: productType })}
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    placeholder={t('Type or generate')}
