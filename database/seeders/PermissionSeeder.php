...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'toggle-status-branches', 'module' => 'branches', 'label' => 'Change Status Branches', 'description' => 'Can change status branches'],

            // Cash Registers Management
            ['name' => 'manage-cash-registers', 'module' => 'cash_registers', 'label' => 'Manage Cash Registers', 'description' => 'Can manage cash registers'],
            ['name' => 'view-cash-registers', 'module' => 'cash_registers', 'label' => 'View Cash Registers', 'description' => 'View Cash Registers'],
            ['name' => 'create-cash-registers', 'module' => 'cash_registers', 'label' => 'Create Cash Registers', 'description' => 'Can create cash registers'],
            ['name' => 'edit-cash-registers', 'module' => 'cash_registers', 'label' => 'Edit Cash Registers', 'description' => 'Can edit cash registers'],
            ['name' => 'delete-cash-registers', 'module' => 'cash_registers', 'label' => 'Delete Cash Registers', 'description' => 'Can delete cash registers'],
            ['name' => 'toggle-status-cash-registers', 'module' => 'cash_registers', 'label' => 'Change Status Cash Registers', 'description' => 'Can change status cash registers'],

            // POS Management
            ['name' => 'manage-pos-sessions', 'module' => 'pos_sessions', 'label' => 'Manage POS Sessions', 'description' => 'Can manage POS sessions'],
            ['name' => 'view-pos-sessions', 'module' => 'pos_sessions', 'label' => 'View POS Sessions', 'description' => 'View POS Sessions'],
            ['name' => 'create-pos-sessions', 'module' => 'pos_sessions', 'label' => 'Start POS Sessions', 'description' => 'Can start POS sessions'],
            ['name' => 'close-pos-sessions', 'module' => 'pos_sessions', 'label' => 'Close POS Sessions', 'description' => 'Can close POS sessions'],
            ['name' => 'edit-pos-sessions', 'module' => 'pos_sessions', 'label' => 'Edit POS Sessions', 'description' => 'Can edit POS sessions'],
            ['name' => 'delete-pos-sessions', 'module' => 'pos_sessions', 'label' => 'Delete POS Sessions', 'description' => 'Can delete POS sessions'],
            ['name' => 'manage-any-pos-sessions', 'module' => 'pos_sessions', 'label' => 'Manage Any POS Sessions', 'description' => 'Manage Any Users POS Sessions'],
            ...
            // Unit management
            ['name' => 'manage-units', 'module' => 'units', 'label' => 'Manage Units', 'description' => 'Can manage units'],
            ['name' => 'view-units', 'module' => 'units', 'label' => 'View Units', 'description' => 'View Units'],
            ['name' => 'create-units', 'module' => 'units', 'label' => 'Create Units', 'description' => 'Can create units'],
            ['name' => 'edit-units', 'module' => 'units', 'label' => 'Edit Units', 'description' => 'Can edit units'],
            ['name' => 'delete-units', 'module' => 'units', 'label' => 'Delete Units', 'description' => 'Can delete units'],
            ['name' => 'toggle-status-units', 'module' => 'units', 'label' => 'Toggle Status Units', 'description' => 'Can toggle status units'],
            ...
            ['name' => 'manage-generic-names', 'module' => 'generic-names', 'label' => 'Manage Generic Names', 'description' => 'Can manage generic names'],
            ['name' => 'view-generic-names', 'module' => 'generic-names', 'label' => 'View Generic Names', 'description' => 'View Generic Names'],
            ['name' => 'create-generic-names', 'module' => 'generic-names', 'label' => 'Create Generic Names', 'description' => 'Can create generic names'],
            ['name' => 'edit-generic-names', 'module' => 'generic-names', 'label' => 'Edit Generic Names', 'description' => 'Can edit generic names'],
            ['name' => 'delete-generic-names', 'module' => 'generic-names', 'label' => 'Delete Generic Names', 'description' => 'Can delete generic names'],
            ['name' => 'toggle-status-generic-names', 'module' => 'generic-names', 'label' => 'Toggle Status Generic Names', 'description' => 'Can toggle status generic names'],

            // Drug Forms management
            ['name' => 'manage-drug-forms', 'module' => 'drug-forms', 'label' => 'Manage Drug Forms', 'description' => 'Can manage drug forms'],
            ['name' => 'view-drug-forms', 'module' => 'drug-forms', 'label' => 'View Drug Forms', 'description' => 'View Drug Forms'],
            ['name' => 'create-drug-forms', 'module' => 'drug-forms', 'label' => 'Create Drug Forms', 'description' => 'Can create drug forms'],
            ['name' => 'edit-drug-forms', 'module' => 'drug-forms', 'label' => 'Edit Drug Forms', 'description' => 'Can edit drug forms'],
            ['name' => 'delete-drug-forms', 'module' => 'drug-forms', 'label' => 'Delete Drug Forms', 'description' => 'Can delete drug forms'],
            ['name' => 'toggle-status-drug-forms', 'module' => 'drug-forms', 'label' => 'Toggle Status Drug Forms', 'description' => 'Can toggle status drug forms'],
            ...
            ['name' => 'view-sales-reports', 'module' => 'reports', 'label' => 'View Sales Reports', 'description' => 'Can view sales reports'],
            ['name' => 'view-customer-details-report', 'module' => 'reports', 'label' => 'View Customer Details Report', 'description' => 'Can view customer details report'],
            ['name' => 'view-supplier-details-report', 'module' => 'reports', 'label' => 'View Supplier Details Report', 'description' => 'Can view supplier details report'],
            ['name' => 'view-supplier-ledger-card', 'module' => 'reports', 'label' => 'View Supplier Ledger Card', 'description' => 'Can view supplier ledger card report'],
            ['name' => 'view-customer-ledger-card', 'module' => 'reports', 'label' => 'View Customer Ledger Card', 'description' => 'Can view customer ledger card report'],
            ['name' => 'view-price-details-report', 'module' => 'reports', 'label' => 'View Price Details Report', 'description' => 'Can view price details report'],
            ['name' => 'view-cash-collection-report', 'module' => 'reports', 'label' => 'View Cash Collection Report', 'description' => 'Can view cash collection report'],
            ...
            ['name' => 'manage-inventory', 'module' => 'inventory', 'label' => 'Manage Inventory', 'description' => 'Can access inventory module'],
            ['name' => 'view-inventory-transactions', 'module' => 'inventory', 'label' => 'View Inventory Transactions', 'description' => 'Can view inventory transactions'],
            ['name' => 'view-inventory-dashboard', 'module' => 'inventory', 'label' => 'View Inventory Dashboard', 'description' => 'Can view inventory dashboard'],
            ['name' => 'view-inventory-audit', 'module' => 'inventory', 'label' => 'View Inventory Audit', 'description' => 'Can view inventory audit records'],
            ['name' => 'manage-drug-destroys', 'module' => 'inventory', 'label' => 'Manage Drug Destroys', 'description' => 'Can manage drug destruction records'],
            ['name' => 'view-drug-destroys', 'module' => 'inventory', 'label' => 'View Drug Destroys', 'description' => 'Can view drug destruction reports'],
            ['name' => 'create-drug-destroys', 'module' => 'inventory', 'label' => 'Create Drug Destroys', 'description' => 'Can record drug destructions'],
            ['name' => 'manage-customer-payments', 'module' => 'inventory', 'label' => 'Manage Customer Payments', 'description' => 'Can manage customer payments'],
            ['name' => 'view-customer-payments', 'module' => 'inventory', 'label' => 'View Customer Payments', 'description' => 'Can view customer payments'],
            ['name' => 'create-customer-payments', 'module' => 'inventory', 'label' => 'Create Customer Payments', 'description' => 'Can record customer payments'],
            ['name' => 'view-customer-returns', 'module' => 'inventory', 'label' => 'View Customer Returns', 'description' => 'Can view customer returns'],
            ['name' => 'create-customer-returns', 'module' => 'inventory', 'label' => 'Create Customer Returns', 'description' => 'Can record customer returns'],
            // GRN management
            ['name' => 'manage-grns', 'module' => 'grns', 'label' => 'Manage GRNs', 'description' => 'Can create, edit and delete GRNs'],
            ['name' => 'view-grns', 'module' => 'grns', 'label' => 'View GRNs', 'description' => 'Can view GRN list and details'],

            // Sales Transaction management
            ['name' => 'manage-sales', 'module' => 'sales', 'label' => 'Manage Sales', 'description' => 'Can manage all sales transactions'],
            ['name' => 'view-sales', 'module' => 'sales', 'label' => 'View Sales', 'description' => 'Can view sales transaction list and details'],
            ['name' => 'create-sales', 'module' => 'sales', 'label' => 'Create Sales', 'description' => 'Can create new sales transactions'],
            ['name' => 'edit-sales', 'module' => 'sales', 'label' => 'Edit Sales', 'description' => 'Can edit existing sales transactions'],
            ['name' => 'delete-sales', 'module' => 'sales', 'label' => 'Delete Sales', 'description' => 'Can delete sales transactions'],
            ['name' => 'edit-completed-sales', 'module' => 'sales', 'label' => 'Edit Completed Sales', 'description' => 'Can edit sales transactions even after they are completed'],
            ['name' => 'toggle-status-sales', 'module' => 'sales', 'label' => 'Toggle Status Sales', 'description' => 'Can change sales transaction status'],
            ['name' => 'manage-points-earning-rules', 'module' => 'sales', 'label' => 'Manage Points Earning Rules', 'description' => 'Can configure loyalty points earning rules'],

            // Finance management
            ['name' => 'manage-finance', 'module' => 'finance', 'label' => 'Manage Finance', 'description' => 'Can access and manage the finance module'],

            // Good Issue Notes management
            ['name' => 'manage-good-issue-notes', 'module' => 'inventory', 'label' => 'Manage Good Issue Notes', 'description' => 'Can manage good issue notes'],
            ['name' => 'view-good-issue-notes', 'module' => 'inventory', 'label' => 'View Good Issue Notes', 'description' => 'Can view good issue notes'],
            ['name' => 'create-good-issue-notes', 'module' => 'inventory', 'label' => 'Create Good Issue Notes', 'description' => 'Can create good issue notes'],
            ['name' => 'edit-good-issue-notes', 'module' => 'inventory', 'label' => 'Edit Good Issue Notes', 'description' => 'Can edit good issue notes'],
            ['name' => 'delete-good-issue-notes', 'module' => 'inventory', 'label' => 'Delete Good Issue Notes', 'description' => 'Can delete good issue notes'],
            ['name' => 'toggle-status-good-issue-notes', 'module' => 'inventory', 'label' => 'Toggle Status Good Issue Notes', 'description' => 'Can toggle status good issue notes'],

            // Customer Portal
            ['name' => 'view-customer-portal', 'module' => 'customer_portal', 'label' => 'View Customer Portal', 'description' => 'Access customer self-service portal'],
            ['name' => 'manage-prescriptions', 'module' => 'customer_portal', 'label' => 'Manage Prescriptions', 'description' => 'View and manage customer prescription requests'],

            // Delivery Route management
            ['name' => 'manage-delivery-routes', 'module' => 'delivery_routes', 'label' => 'Manage Delivery Routes', 'description' => 'Can manage delivery routes'],
            ['name' => 'view-delivery-routes', 'module' => 'delivery_routes', 'label' => 'View Delivery Routes', 'description' => 'View Delivery Routes'],
            ['name' => 'create-delivery-routes', 'module' => 'delivery_routes', 'label' => 'Create Delivery Routes', 'description' => 'Can create delivery routes'],
            ['name' => 'edit-delivery-routes', 'module' => 'delivery_routes', 'label' => 'Edit Delivery Routes', 'description' => 'Can edit delivery routes'],
            ['name' => 'delete-delivery-routes', 'module' => 'delivery_routes', 'label' => 'Delete Delivery Routes', 'description' => 'Can delete delivery routes'],
            ['name' => 'toggle-status-delivery-routes', 'module' => 'delivery_routes', 'label' => 'Toggle Status Delivery Routes', 'description' => 'Can toggle status delivery routes'],
