...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        $systemSettings['invoiceTemplate'] = (int) getSetting('invoiceTemplate', 1, $user->id);
        $systemSettings['invoiceTemplateColor'] = getSetting('invoiceTemplateColor', '003580', $user->id);
        $systemSettings['isQrEnabled'] = getSetting('isQrEnabled', '0', $user->id) === '1';
        $systemSettings['invoiceLogo'] = getSetting('invoiceLogo', null, $user->id);
